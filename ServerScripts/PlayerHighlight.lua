...
local HIGHLIGHT_SETTINGS = {
	FillColor = Color3.fromRGB(255, 255, 255),       -- White fill
	FillTransparency = 0.85,                         -- Very transparent fill
	OutlineColor = Color3.fromRGB(67, 67, 67),       -- Dark gray outline
	OutlineTransparency = 0.4,                       -- Semi-transparent outline
	DepthMode = Enum.HighlightDepthMode.AlwaysOnTop, -- Always visible through walls
	Enabled = true
}
